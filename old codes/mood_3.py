...
def generate_pdf_report(asana: YogaAsana, user_prompt: str, similarity: float, final_comment: str):
    ...
    try:
        ...
        # Frequency
        c.setFont("Helvetica-Bold", 14)
        c.drawString(left_margin, top_margin - 240, "Frequency:")
        c.setFont("Helvetica", 12)
        c.drawString(left_margin, top_margin - 260, asana.frequency)

        # Timing
        c.setFont("Helvetica-Bold", 14)
        c.drawString(left_margin, top_margin - 280, "Timing:")
        c.setFont("Helvetica", 12)
        c.drawString(left_margin, top_margin - 300, asana.timing)

        # Dietary Recommendations
        c.setFont("Helvetica-Bold", 14)
        c.drawString(left_margin, top_margin - 320, "Dietary Recommendations:")
        c.setFont("Helvetica", 12)
        text = c.beginText(left_margin, top_margin - 340)
        ...
        c.setFont("Helvetica-Bold", 14)
        c.drawString(left_margin, top_margin - 420, "Lifestyle Recommendations:")
        c.setFont("Helvetica", 12)
        text = c.beginText(left_margin, top_margin - 440)
        ...
        # Benefits
        c.setFont("Helvetica-Bold", 14)
        c.drawString(left_margin, top_margin - 520, "Benefits:")
        c.setFont("Helvetica", 12)
        text = c.beginText(left_margin, top_margin - 540)
        ...
        c.setFont("Helvetica-Bold", 14)
        c.drawString(left_margin, top_margin - 620, "Final Comment:")
        c.setFont("Helvetica", 12)
        ...
        final_comment_y = top_margin - 640
        final_comment_width = width - left_margin - right_margin
        final_comment_height = 100  # Adjust as needed
